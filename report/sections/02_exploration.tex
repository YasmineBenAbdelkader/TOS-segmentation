...
d'orienter le choix de séquence de référence pour la Phase 1. Pour CLAV, MSC, K1 et PB, la variance
inter-patient domine l'écart entre séquences : \textbf{aucune conclusion FLASH vs RSSFP ne peut être
tirée de l'EDA seule pour ces 4 structures} ; la vraie comparaison devra venir des métriques du modèle
entraîné (Phase 1).
